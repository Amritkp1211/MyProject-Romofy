...
public class Services {
	...
	public static void sendMail(String emailid,int value){
		final String username  = "amritkp12112000@gmail.com";//Sender Email
		final String password   = "owsacktejwearsub";//Sender Password
	...
	public static void sendMail1(String emailid,String pass){
		final String username  = "amritkp12112000@gmail.com";
		final String password   = "owsacktejwearsub";
